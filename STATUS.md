...
**Current phase:** UNDER REVIEW at Synthese (submitted 2026-07-14, manuscript SYNT-D-26-02696). Submission gate passed in full: cold-read legibility gate 0/3 MISSING and 2/3 advance across three cross-model hostile readers (the JSO defect verified fixed); terminology gate exit 0 against `planning/terms.md`; correctness, content, and anonymity checks clean. Package at `submission/synthese/` (anon PDF, scrubbed source bundle, title page with model-named AI disclosure, cover letter); upload checklist in `submission/synthese/submission-notes.md`. Venue record: `submission/venue-decision-2026-07-13.md` (fallbacks Ergo, Philosophical Studies). JSO rejected after review (final, no resubmission; reviews at `submission/jso/reviews-2026-07-13.md`, verified triage at `reviews/jso-rejection-triage-2026-07-13.md`). All triage adopt-items landed: section-numbering bug fixed in `scripts/build_jso_submission.py` (pandoc DOCX conversion, not the LaTeX); forced-choice opponent named on page one with the debate placed and bookended in the conclusion; projection restricted to defeasible inference with correlative read-offs set apart (Brett's call); causal-normative network, social cascade, life-cycle, projection profile, and anchoring all defined at first use; projectibility glossed with Goodman 1955 at first mention; "profile" reserved for projection profile; Pearl folded in plainly (Brett's call). Since the gate: Brett's full line-read drove a second revision wave (decompression, contraction directive, kind/type split, thorough structural-redundancy edit by three auditor fleets, three scar passes, paragraph-opening audit, citation repositioning, Lakoff metaphor audit) plus two additions (uptake-need-not-be-endorsement; remedies-and-decay). PhilArchive updated to the current version 2026-07-14. Build clean, 21 pp, texcount 9,025. Submitted 2026-07-14 as SYNT-D-26-02696.
...
**Venue:** Synthese, regular article (submitted 2026-07-14, SYNT-D-26-02696, under review). Prior: Journal of Social Ontology, submitted 2026-05-27, rejected after review 2026-07-13 (final).
...
Some social and moral explanations need causal production, recognitional representation, and field-grounded status-determination represented in one coupled structure. A causal-normative network has three relation-genera displayed by four graph roles: causal edges, recognitional edges, directed status-transition edges, and non-directed correlative ties. Its key payoff is projectibility along the directed graph roles (correlative ties license read-offs, which are exact and indefeasible, not projections) plus the assessment vocabulary: social efficacy, institutional field-validity, communal successful conferral, recognitional fit, enforceability/finality, and moral warrant.
...
- `main.pdf`: current build, 21 pages.
- PhilArchive preprint: `https://philarchive.org/rec/REYEWW` (v1 archived 2026-05-26; updated to the current revision 2026-07-14).
...
- Reverted duplicate 2026-07-04 entries from `references-local.bib` (all three already central; local Woodward copy carried 2014 where the project audit established 2015; the central bib's own 2014 dating is flagged for a portfolio-level pass). Added Goodman1955 to `references-standalone.bib` verbatim from central. Build clean: 22 pp, texcount 9,649, no undefined references, biber error-free; /check-style long-paragraph flags resolved by splitting six paragraphs.

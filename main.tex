...
Four failure modes follow. In \term{false recognition}, uptake outruns status; Pickwick's alleged promise is the comic case. In \term{wrongful institutional validity}, field rules assign the status and field-validity outruns warrant. In \term{wrongful communal conferral}, conferral standing outruns moral authority. In \term{suppressed entitlement}, the field refuses to register a moral basis: warrant outruns recognition.

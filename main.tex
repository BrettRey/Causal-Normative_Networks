...
Epstein's frame principles and anchors (Section~\ref{sec:problem}) do the field-level work here \citep{epstein2015AntTrap}: the field fixes which performances ground which statuses, which records preserve those statuses, which recognitions can alter those statuses, and which defeaters block those statuses.

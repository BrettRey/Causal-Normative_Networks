...
The structure I defend is a \term{causal-normative network}: a directed graph whose nodes are status-relevant items, states, and events, and whose edges are relations of real dependence. The dependence comes in three relation-genera, displayed by four graph roles.
...
Figure~\ref{fig:promise} renders a promise as a small typed-edge network, with the four graph roles that recur across the carrying cases.
